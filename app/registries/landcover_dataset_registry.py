...
LAND_COVER_LEGENDS: Dict[str, Dict] = {
    ...
    "ESA_CCI_LandCover_2018": {
        "1":  {"color": "#FFFF64", "label": "Mostly Cropland"},
        "2":  {"color": "#FFB432", "label": "Grassland, Scrub, or Shrub"},
        "3":  {"color": "#78D203", "label": "Mostly Deciduous Forest"},
        "4":  {"color": "#006400", "label": "Mostly Needleleaf/Evergreen Forest"},
        "5":  {"color": "#FFEBAF", "label": "Sparse Vegetation"},
        "6":  {"color": "#FFF5D7", "label": "Bare Area"},
        "7":  {"color": "#00785A", "label": "Swampy or Often Flooded Vegetation"},
        "8":  {"color": "#C31400", "label": "Artificial Surface or Urban Area"},
        "9":  {"color": "#0046C8", "label": "Surface Water"},
        "10": {"color": "#FFFFFF", "label": "Permanent Snow and Ice"},
    },
...
LAND_COVER_VIS: Dict[str, Dict] = {
    ...
    "ESA_CCI_LandCover_2018":  {"min": 1,  "max": 10,  "palette": ["FFFF64","FFB432","78D203","006400","FFEBAF","FFF5D7","00785A","C31400","0046C8","FFFFFF"]},
...
LAND_COVER_DATASET_OPTIONS: Dict[str, Dict] = {
    ...
    "ESA_CCI_LandCover_2018": {
        "name":                "ESA CCI Land Cover 2018 (ArcGIS Living Atlas)",
        "source":              "ArcGIS Living Atlas",
        ...
        "time_aware":          False,
        "gee_id":              None,
        "arcgis_item_id":      "fe200cff94624a938b042d68beeaa13a",
        "arcgis_service_url":  "https://env1.arcgis.com/arcgis/rest/services/esa_cci_landcover_2018/ImageServer",
        "requires_auth":       False,
        "supports_summary":    True,
        "supports_transition": False,
        "official_url":        "https://www.arcgis.com/home/item.html?id=fe200cff94624a938b042d68beeaa13a",
        "publication_url":     "https://climate.esa.int/en/projects/land-cover/",
        "limitations":         [
            "Static snapshot — only 2018 data available via this service.",
            "300m resolution; suitable for regional/national scale analysis only.",
            "10 aggregated classes (LCCS aggregated by Esri).",
        ],
        "description":         "ESA CCI Land Cover 2018 snapshot at 300m from ArcGIS Living Atlas, aggregated to 10 broad classes.",
        "model":               "ESA CCI land cover classification using AVHRR, SPOT-VGT, PROBA-V, and Sentinel-3 time series. Original product has 37 classes; Living Atlas service uses 10 aggregated LCCS classes.",
        "accuracy":            "ESA CCI Land Cover Collection v2.1.1 overall accuracy approximately 71.1% at global scale.",
        "attribution":         "ESA Climate Change Initiative — Land Cover project",
        "class_schema":        "ESA_CCI_AGGREGATED_10",
    },
    "DEA_Mangroves": {
