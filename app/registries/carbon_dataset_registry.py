...
CARBON_DATASET_REGISTRY: dict[str, dict] = {
    "WCMC": {
        ...
        "full_name":   "UN WCMC Global Above & Belowground Biomass Carbon Density v1.0",
        ...
        "transform":   "none",
        "description": "Global above- and belowground biomass carbon density circa 2010. Training target for WCMC-compatible models.",
...
CARBON_EXTERNAL_REGISTRY: dict[str, dict] = {
    ...
    "HANSEN_TREECOVER_AGB_PROXY": {
        ...
        "available_years":  list(range(2000, 2024)),
        "time_aware":       False,
